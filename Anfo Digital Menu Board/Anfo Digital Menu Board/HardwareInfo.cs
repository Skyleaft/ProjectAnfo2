...
public static class HardwareInfo
{
    ...
    public static String GetBaterylevel()
    {
        ...
        foreach (ManagementObject mo in moc)
        {
            ...
            Id = mo.Properties["EstimatedChargeRemaining"].Value.ToString();
            break;
        }
        return Id;

    }
    public static String GetBaterycharge()
    {
        ...
        foreach (ManagementObject mo in moc)
        {
            ...
            Id = mo.Properties["BatteryStatus"].Value.ToString();
            break;
        }
        return Id;

    }
    public static String Getvganame()
    {
